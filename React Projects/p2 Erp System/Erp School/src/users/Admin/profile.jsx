...
export default function UserProfile() {
  return (
    <>
    <Nav />
    <div className="w-full p-2  bg-emerald-200 rounded-sm border-1 border-black mt-1">
    ...
    <form className='flex flex-col bg-emerald-200 text-white  border-2 border-black rounded-sm'>
