...
export default function Banner(props) {
  return (
    <div className="relative isolate flex  items-center gap-x-6 overflow-hidden bg-gray-100 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div
        aria-hidden="true"
        className="absolute border rounded-sm left-[max(-7rem,calc(50%-52rem))] top-1/2 -z-10 -translate-y-1/2 transform-gpu blur-2xl"
      >
        <div
          style={{
            clipPath:
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        >
          Read Full Content <span aria-hidden="true">&rarr;</span>
        </a>
      </div>
